...
-- CreateIndex
CREATE INDEX "Comment_srcId_userId_idx" ON "Comment"("srcId", "userId");
...
-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_srcId_fkey" FOREIGN KEY ("srcId") REFERENCES "Stock"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Like" ADD CONSTRAINT "Like_srcId_fkey" FOREIGN KEY ("srcId") REFERENCES "Stock"("id") ON DELETE CASCADE ON UPDATE CASCADE;
